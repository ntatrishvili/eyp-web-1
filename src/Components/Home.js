  ...
  return (
    <>
      ...
      <div className='card' key={1}>
          ...
          <div className='news'>
            <div className='newsHeader'>Tskaltubo'23</div>
            <div className='newsInfo'>
      ...
      <div className='card' key={2}>
          ...
          <div className='news'>
            <div className='newsHeader'>National Committee Management Day 2023</div>
            <div className='newsInfo'>
      ...
      <div className='card' key={3}>
          ...
          <div className='news'>
            <div className='newsHeader'>#EYPinAction'23</div>
            <div className='newsInfo'>
      ...
      <div className='card' key={4}>
          ...
          <div className='news'>
            <div className='newsHeader'>Tiflisi International Forum 2023</div>
            <div className='newsInfo'>
